...
import 'package:follow_read/pages/entry/entry_controller.dart';
import 'package:follow_read/widgets/acx/buttonx.dart';
import 'package:follow_read/widgets/acx/cupx_app_bar.dart';
import 'package:follow_read/widgets/acx/no_more.dart';
import 'package:follow_read/widgets/acx/padded_svg_icon.dart';
import 'package:follow_read/widgets/acx/tab_barx.dart';
import 'package:follow_read/widgets/detail/entry_content.dart';
import 'package:follow_read/widgets/detail/entry_image.dart';
import 'package:follow_read/widgets/detail/entry_title.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, _) {
        if (didPop) {
          ref.read(entryProvider(entryId).notifier).read(status: Model.read);
        }
      },
      child: child,
    );
