...
class MenuDivider extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return SpacerDivider(indent: 0, thickness: thickness, spacing: 0, color: AppColors.black08,);
  }
}
      ...
      child: Row(children: [
        ...
        if (icon != null) ...[
          ...
          SvgPicture.asset(icon!, width: 20, height: 20, fit: BoxFit.contain,
            colorFilter: ColorFilter.mode(AppColors.black95, BlendMode.srcIn),
          ),
          const SizedBox(width: 4,),
        ],
