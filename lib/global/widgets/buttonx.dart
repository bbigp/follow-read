...
ButtonxSize medium() {
  return ButtonxSize(height: 44, width: double.infinity,
    borderRadius: BorderRadius.circular(10), textSize: AppTextStyles.M15,
  );
}
...
ButtonxColor primary() { //黑色背景 白色字体
  return ButtonxColor(
    color: Colors.white, disabledColor: AppColors.black25,
    backgroundColor: AppColors.black95, disabledBackgroundColor: AppColors.black08,
  );
}
ButtonxColor secondary() { //灰色背景 黑色字体
  return ButtonxColor(
    color: AppColors.black95, disabledColor: AppColors.black25,
    backgroundColor: AppColors.black04, disabledBackgroundColor: AppColors.black04,
  );
}
...
ButtonxColor stroked() {//透明背景 黑色字体 带描边
  return ButtonxColor(
    color: AppColors.black95, disabledColor: AppColors.black25,
    backgroundColor: Colors.transparent, disabledBackgroundColor: AppColors.black04,
    borderColor: AppColors.black08,
  );
}
ButtonxColor danger() { //红色背景 红色字体
  return ButtonxColor(
    color: AppColors.red00, disabledColor: AppColors.black25,
    backgroundColor: AppColors.red10, disabledBackgroundColor: AppColors.black04,
  );
}
ButtonxColor info() {
  return ButtonxColor(
      color: AppColors.blue00, disabledColor: AppColors.black25,
      backgroundColor: AppColors.blue10, disabledBackgroundColor: AppColors.black04,
  );
}
